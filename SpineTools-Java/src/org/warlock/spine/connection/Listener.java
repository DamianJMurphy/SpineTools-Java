...
/**
 * Listen for inbound Spine messages. Handle de-duplication for reliable interactions,
 * and call message handlers.
 * 
 * This is typically started from within the ConnectionManager, using the listen()
 * method.
 * 
    ...
    extends Thread
{
     ...
     * 
     * @param p HashMap of service/interaction values against persist duration in seconds. 
     */
     ...
     * @param c 
     * @throws IllegalArgumentException if given a null context, or one that is not set up.
     */
    ...
    public void setPort(int p) { listenPort = p; }
    ...
    /**
     * Internal call from the Connection Manager to register the receipt of a message.
     * This method provides the de-duplication check, as well as recording the
     * receipt of a previously-unseen message.
     * 
     ...
     * @param a The address on which to liste, or 0.0.0.0 (all interfaces) if null.
     * @throws Exception 
     */
